  ...
  return (
    <div className="bg-emerald-950 dark:bg-gray-900 min-h-screen w-screen flex flex-col">
      ...
      {showButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 right-6 bg-yellow-400 text-emerald-950 p-3 rounded-full shadow-lg   hover:bg-gray-700 hover:text-yellow-400 ransition duration-300"
        >
          <FaArrowUp size={10} />
        </button>
      )}
